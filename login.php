	...
	<nav aria-label="breadcrumb" class="breadcrumb-nav">
		<div class="container">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item"><a href="login.php">تسجيل الدخول</a></li>
			</ol>
		</div>
	</nav>
	<div class="container">
		...
		<?php
			if(isset($_POST['user_login']))
			{
				...
				if(empty($userLogin))
				{
					echo '<div class="alert alert-danger">المعلومات ليست صحيحة , حازل مرة اخرى</div>';
				}
			}
		?>
						...
						<div class="col-md-5 offset-md-1">
							<div class="featured-box featured-box-primary text-left mt-5">
								<div class="box-content">
									<h2 class="color-primary font-weight-semibold text-4 text-uppercase mb-3">تسجيبل الدخول</h2>
									<form action="" id="frmSignIn" method="post" class="needs-validation">
										<div class="form-row">
											<div class="form-group col">
												<label class="font-weight-bold text-dark text-2">الايميل</label>
												<input type="email" name="user_email" class="form-control form-control-lg" placeholder="اكتب الايميل" required>
											</div>
										</div>
										<div class="form-row">
											<div class="form-group col">
												<a class="float-right" href="user-password.php">(نسيت كلمة السر ؟?)</a>
												<label class="font-weight-bold text-dark text-2">كلمة السر</label>
										...
										<div class="form-footer">
											<a href="index.php" class="btn btn-outline-warning">
												<i class="icon-angle-double-left"></i>ارجع للقائمة الرئيسية
											</a>
											<div class="form-footer-right">
												<button type="submit" name="user_login" class="btn btn-primary">تسجيب الدخول</button>
											</div>
										</div>
										<div class="form-row">
											<div class="font-weight-bold text-info text-2">
												او | <a href="register-account.php" class="btn btn-info">تسجيل حساب جديد</a>
											</div>
										</div>
									</form>
								</div>
